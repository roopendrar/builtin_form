...
class SampleForm(forms.Form):
    first_name=forms.CharField(max_length=20,required=True,label="First Name",help_text="Note:no special charecters is allowed")
    ...
    phno=forms.IntegerField(max_value=999999999,min_value=60000000000,required=True,label="Phone Number")
